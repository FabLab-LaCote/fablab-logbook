...
class FablabLogbook_OptionsManager {
    ...
    public function settingsPage() {
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'fablab-logbook'); ?></h2>
            <table class="form-table"><tbody>
            <tr><td><?php _e('System', 'fablab-logbook'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'fablab-logbook'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'fablab-logbook');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'fablab-logbook'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'fablab-logbook');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'fablab-logbook'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'fablab-logbook') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'fablab-logbook');
            case 'false':
                return __('false', 'fablab-logbook');

            case 'Administrator':
                return __('Administrator', 'fablab-logbook');
            case 'Editor':
                return __('Editor', 'fablab-logbook');
            case 'Author':
                return __('Author', 'fablab-logbook');
            case 'Contributor':
                return __('Contributor', 'fablab-logbook');
            case 'Subscriber':
                return __('Subscriber', 'fablab-logbook');
            case 'Anyone':
                return __('Anyone', 'fablab-logbook');
        }
        return $optionValue;
    }
